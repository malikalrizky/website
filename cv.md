...
Lead SOC operations for a Indonesia-based fintech, owning incident response strategy, detection engineering, threat hunting, and automation across AWS, GCP, Kubernetes, endpoints, and identity systems in multi-country environments.
...
Secure identity and cloud operations across AWS and GCP while serving as primary SecOps on-call, owning detection-to-remediation workflows and strengthening governance controls that support progression to Lead SOC.
...
Cloud Security | DevSecOps | AWS | GCP | Docker | Kubernetes | Terraform | Python | JavaScript | React | Node.js | PostgreSQL | CI/CD | SIEM | IAM | Incident Response | Vulnerability Assessment | Penetration Testing | ISO 27001 | ELK Stack | Grafana | Prometheus
